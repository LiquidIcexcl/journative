  ...
  return (
    ...
    <SafeAreaView className='flex-1 bg-myBackGround flex-col items-center'> 
      ...
      <TextInput
        ...
        className='w-[300px] h-[40px] rounded-lg border-myGreen border-b-2 mt-10 p-2'
      />
      ...
      <TextInput
        ...
        className='w-[300px] h-[250px] rounded-lg border-myGreen border-b-4 p-2 justify-start'
      />
